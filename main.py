...
while run:
    ...
    # move player
    screen_scroll, level_complete = player.move(dx,dy, world.obstacles_tiles, world.exit_tile)
    ...
    for arrow in arrow_group: 
        damage, damage_pos =arrow.update(screen_scroll, world.obstacles_tiles,enemy_list)
        if damage:
